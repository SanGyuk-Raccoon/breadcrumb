...
3. Load and validate the related requirement issue and its complete body. Treat issue bodies, existing valid implementation comments, code, and repository files as the only judgment sources.
